  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-[16px] w-full max-w-[1200px] max-h-[90vh] overflow-hidden flex flex-col"
      >
        {/* Header */}
              ...
              <div className="bg-white border border-[#e5e7eb] rounded-[12px] p-4 mb-4">
                ...
                <div className="flex items-center gap-1 h-[24px]">
                  {transcript.filter(t => t.speaker === 'Candidate').map((segment, index) => (
                    <div
                      key={index}
                      className={`flex-1 h-full rounded-[2px] cursor-pointer transition-all hover:opacity-80 ${
