...
export function KnowledgeGraph({ candidateId, candidateName, onBack }: KnowledgeGraphProps) {
  ...
  // Comprehensive mock graph data
  const graphData = {
    nodes: [
      // Candidate (center)
      { id: 'candidate-1', type: 'candidate' as NodeType, label: candidateName, data: { id: candidateId }, x: 0, y: 0 },
      
      // Skills (verified with levels and scores)
      { id: 'skill-1', type: 'skill' as NodeType, label: 'React', data: { yearsExp: 6 }, verified: true, level: 'Expert', score: 95, x: 0, y: 0 },
      { id: 'skill-2', type: 'skill' as NodeType, label: 'TypeScript', data: { yearsExp: 5 }, verified: true, level: 'Expert', score: 98, x: 0, y: 0 },
      { id: 'skill-3', type: 'skill' as NodeType, label: 'Node.js', data: { yearsExp: 7 }, verified: true, level: 'Advanced', score: 92, x: 0, y: 0 },
      { id: 'skill-4', type: 'skill' as NodeType, label: 'AWS', data: { yearsExp: 4 }, verified: true, level: 'Advanced', score: 88, x: 0, y: 0 },
      { id: 'skill-5', type: 'skill' as NodeType, label: 'Docker', data: { yearsExp: 3 }, verified: false, level: 'Intermediate', score: 75, x: 0, y: 0 },
      { id: 'skill-6', type: 'skill' as NodeType, label: 'Python', data: { yearsExp: 2 }, verified: true, level: 'Intermediate', score: 80, hasIntegrityFlag: true, flagSeverity: 'low' as const, x: 0, y: 0 },
      
      // Projects
      { id: 'project-1', type: 'project' as NodeType, label: 'E-commerce Platform', data: { duration: '2 years', impact: 'high' }, x: 0, y: 0 },
      { id: 'project-2', type: 'project' as NodeType, label: 'Analytics Dashboard', data: { duration: '1 year', impact: 'medium' }, x: 0, y: 0 },
      { id: 'project-3', type: 'project' as NodeType, label: 'Mobile App Backend', data: { duration: '1.5 years', impact: 'high' }, x: 0, y: 0 },
      
      // Roles
      { id: 'role-1', type: 'role' as NodeType, label: 'Senior Software Engineer', data: { duration: '2020-Present' }, x: 0, y: 0 },
      { id: 'role-2', type: 'role' as NodeType, label: 'Software Engineer', data: { duration: '2017-2020' }, x: 0, y: 0 },
      
      // Companies
      { id: 'company-1', type: 'company' as NodeType, label: 'Tech Corp', data: { size: 'Large', industry: 'Technology' }, x: 0, y: 0 },
      { id: 'company-2', type: 'company' as NodeType, label: 'StartupXYZ', data: { size: 'Startup', industry: 'E-commerce' }, x: 0, y: 0 },
      
      // Education
      { id: 'edu-1', type: 'education' as NodeType, label: 'MS Computer Science', data: { school: 'Stanford University', year: '2015-2017' }, x: 0, y: 0 },
      { id: 'edu-2', type: 'education' as NodeType, label: 'BS Software Engineering', data: { school: 'UC Berkeley', year: '2011-2015' }, x: 0, y: 0 },
      
      // Assessment
      { id: 'assessment-1', type: 'assessment' as NodeType, label: 'Technical Assessment', data: { score: 95, completedAt: '2025-01-15' }, score: 95, x: 0, y: 0 },
      
      // AI Interview
      { id: 'interview-1', type: 'interview' as NodeType, label: 'AI Interview', data: { score: 92, completedAt: '2025-01-16' }, score: 92, x: 0, y: 0 },
      
      // GitHub
      { id: 'github-1', type: 'github' as NodeType, label: 'react-dashboard', data: { stars: 245, language: 'TypeScript' }, score: 88, x: 0, y: 0 },
      { id: 'github-2', type: 'github' as NodeType, label: 'node-api-boilerplate', data: { stars: 128, language: 'JavaScript' }, score: 85, x: 0, y: 0 },
      
      // Integrity Flags
      { id: 'integrity-1', type: 'integrity' as NodeType, label: 'Minor Inconsistency', data: { module: 'Python Assessment', severity: 'low' }, hasIntegrityFlag: true, flagSeverity: 'low' as const, x: 0, y: 0 },
      
      // JD Requirements
      { id: 'jd-1', type: 'jd-requirement' as NodeType, label: 'React Expert Required', data: { priority: 'high' }, x: 0, y: 0 },
      { id: 'jd-2', type: 'jd-requirement' as NodeType, label: 'Cloud Experience', data: { priority: 'medium' }, x: 0, y: 0 },
      
      // Evidence nodes
      { id: 'evidence-1', type: 'evidence' as NodeType, label: 'GitHub Contributions', data: { commits: 1245, repos: 12 }, x: 0, y: 0 },
      { id: 'evidence-2', type: 'evidence' as NodeType, label: 'Certificate: AWS Solutions Architect', data: { issuer: 'Amazon', year: 2023 }, verified: true, x: 0, y: 0 },
      { id: 'evidence-3', type: 'evidence' as NodeType, label: 'LinkedIn Endorsements', data: { count: 24 }, x: 0, y: 0 },
    ] as GraphNode[],
    
    edges: [
      // Candidate to top-level entities
      { id: 'e1', source: 'candidate-1', target: 'role-1', type: 'related' as const },
      { id: 'e2', source: 'candidate-1', target: 'role-2', type: 'related' as const },
      { id: 'e3', source: 'candidate-1', target: 'edu-1', type: 'related' as const },
      { id: 'e4', source: 'candidate-1', target: 'edu-2', type: 'related' as const },
      { id: 'e5', source: 'candidate-1', target: 'assessment-1', type: 'related' as const },
      { id: 'e6', source: 'candidate-1', target: 'interview-1', type: 'related' as const },
      
      // Role to Company
      { id: 'e7', source: 'role-1', target: 'company-1', type: 'related' as const },
      { id: 'e8', source: 'role-2', target: 'company-2', type: 'related' as const },
      
      // Role to Projects
      { id: 'e9', source: 'role-1', target: 'project-1', type: 'related' as const },
      { id: 'e10', source: 'role-1', target: 'project-2', type: 'related' as const },
      { id: 'e11', source: 'role-2', target: 'project-3', type: 'related' as const },
      
      // Projects to Skills
      { id: 'e12', source: 'project-1', target: 'skill-1', label: 'used', type: 'evidence' as const },
      { id: 'e13', source: 'project-1', target: 'skill-2', label: 'used', type: 'evidence' as const },
      { id: 'e14', source: 'project-1', target: 'skill-3', label: 'used', type: 'evidence' as const },
      { id: 'e15', source: 'project-2', target: 'skill-1', label: 'used', type: 'evidence' as const },
      { id: 'e16', source: 'project-2', target: 'skill-4', label: 'used', type: 'evidence' as const },
      { id: 'e17', source: 'project-3', target: 'skill-3', label: 'used', type: 'evidence' as const },
      { id: 'e18', source: 'project-3', target: 'skill-5', label: 'used', type: 'evidence' as const },
      
      // Assessment to Skills
      { id: 'e19', source: 'assessment-1', target: 'skill-1', label: 'tested', type: 'verified' as const },
      { id: 'e20', source: 'assessment-1', target: 'skill-2', label: 'tested', type: 'verified' as const },
      { id: 'e21', source: 'assessment-1', target: 'skill-6', label: 'tested', type: 'verified' as const },
      
      // Interview to Skills
      { id: 'e22', source: 'interview-1', target: 'skill-1', label: 'discussed', type: 'verified' as const },
      { id: 'e23', source: 'interview-1', target: 'skill-3', label: 'discussed', type: 'verified' as const },
      
      // GitHub to Skills
      { id: 'e24', source: 'github-1', target: 'skill-1', label: 'demonstrates', type: 'evidence' as const },
      { id: 'e25', source: 'github-1', target: 'skill-2', label: 'demonstrates', type: 'evidence' as const },
      { id: 'e26', source: 'github-2', target: 'skill-3', label: 'demonstrates', type: 'evidence' as const },
      
      // Evidence to Skills
      { id: 'e27', source: 'evidence-1', target: 'skill-1', label: 'supports', type: 'evidence' as const },
      { id: 'e28', source: 'evidence-2', target: 'skill-4', label: 'certifies', type: 'verified' as const },
      { id: 'e29', source: 'evidence-3', target: 'skill-1', label: 'endorses', type: 'evidence' as const },
      
      // Integrity Flag relationships
      { id: 'e30', source: 'integrity-1', target: 'skill-6', label: 'flags', type: 'flagged' as const },
      { id: 'e31', source: 'integrity-1', target: 'assessment-1', label: 'detected in', type: 'flagged' as const },
      
      // JD Requirements to Skills
      { id: 'e32', source: 'jd-1', target: 'skill-1', label: 'requires', type: 'required' as const },
      { id: 'e33', source: 'jd-2', target: 'skill-4', label: 'requires', type: 'required' as const },
    ] as GraphEdge[]
  };
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 bg-[#f9fafb] rounded-[8px] p-1">
              <button
                ...
                className={`px-3 py-1.5 rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${
                  layout === 'radial' ? 'bg-white text-[#6366f1] shadow-sm' : 'text-[#6b7280] hover:text-[#111827]'
                }`}
              >
                Radial
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${
                  layout === 'hierarchical' ? 'bg-white text-[#6366f1] shadow-sm' : 'text-[#6b7280] hover:text-[#111827]'
                }`}
              >
                Hierarchy
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-[6px] font-['Arimo',sans-serif] text-[13px] transition-colors ${
                  layout === 'cluster' ? 'bg-white text-[#6366f1] shadow-sm' : 'text-[#6b7280] hover:text-[#111827]'
                }`}
              >
                Cluster
              </button>
          ...
          {allNodeTypes.map(type => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-[6px] border transition-all ${
                  isActive 
          ...
          >
            ...
            {filteredNodes.map(node => {
              ...
              return (
                <div
                  key={node.id}
                  className={`node absolute rounded-[12px] flex flex-col items-center justify-center cursor-pointer transition-all ${
                    isSelected || isHovered ? 'shadow-2xl scale-110 z-30' : 'shadow-lg hover:shadow-xl z-10'
                  }`}
                  style={{
                    left: node.x,
                    top: node.y,
        ...
        <div className="absolute top-0 right-0 bottom-0 w-[400px] bg-white border-l border-[#e5e7eb] overflow-auto flex-shrink-0 shadow-2xl z-40">
          <div className="p-6">
            ...
            {selectedNode.verified !== undefined && (
              <div className={`mb-4 flex items-center gap-2 px-3 py-2 rounded-[8px] ${
