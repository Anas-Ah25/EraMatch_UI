...
import { ChevronLeft, Play, Pause, SkipForward, AlertTriangle, Flag, Mail, X, FileText, Clock, User, Video, Building2 } from 'lucide-react';
...
interface AdminSuspectReviewPageProps {
  eventId: string;
  candidateId: number;
...
export function AdminSuspectReviewPage({
  eventId,
  candidateId,
  candidateName,
  position,
  ...
  return (
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <div className="bg-white border-b border-[#e5e7eb] px-8 py-6">
        ...
        >
          <ChevronLeft size={16} />
          Back to Suspicious Events
        </button>
        
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              <h1 className="text-[#111827]">Suspicious Event Review - {eventId}</h1>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-[600px]">
              <div className="flex items-center gap-2">
                ...
                <span className="font-['Arimo',sans-serif] text-[13px] text-[#111827] font-medium">
      ...
      <div className="p-8">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-8 space-y-6">
            ...
            {/* Admin Actions Panel */}
            <div className="bg-gradient-to-br from-[#eff6ff] to-[#dbeafe] rounded-[12px] border border-[#bfdbfe] p-6">
              <h3 className="text-[#1e40af] text-[16px] mb-4 flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="h-[40px] px-[16px] rounded-[8px] border border-[#3b82f6] bg-white hover:bg-[#eff6ff] font-['Arimo',sans-serif] text-[14px] text-[#3b82f6] transition-colors flex items-center justify-center gap-2"
                >
                  <Mail size={16} />
                ...
                <button
                  ...
                  className="h-[40px] px-[16px] rounded-[8px] bg-[#ef4444] hover:bg-[#dc2626] font-['Arimo',sans-serif] text-[14px] text-white transition-colors flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="h-[40px] px-[16px] rounded-[8px] bg-[#10b981] hover:bg-[#059669] font-['Arimo',sans-serif] text-[14px] text-white transition-colors col-span-2"
                >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`px-[6px] py-[2px] rounded-[4px] font-['Arimo',sans-serif] text-[10px] uppercase border ${getSeverityColor(flag.severity)}`}>
                              {flag.severity}
                            </span>
                          </div>
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-[100px] px-[12px] py-[10px] border border-[#e5e7eb] rounded-[8px] font-['Arimo',sans-serif] text-[13px] mb-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#6366f1]"
            />
            <div className="flex items-center justify-end gap-3">
              <button
                onClick={() => setShowEscalateModal(false)}
                className="h-[36px] px-[16px] rounded-[8px] border border-[#e5e7eb] font-['Arimo',sans-serif] text-[13px] text-[#111827] hover:bg-[#f9fafb] transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="h-[36px] px-[16px] rounded-[8px] bg-[#ef4444] hover:bg-[#dc2626] font-['Arimo',sans-serif] text-[13px] text-white transition-colors"
              >
                Escalate Issue
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-[200px] px-[12px] py-[10px] border border-[#e5e7eb] rounded-[8px] font-['Arimo',sans-serif] text-[13px] mb-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#6366f1]"
            />
            <div className="flex items-center justify-end gap-3">
              <button
                onClick={() => setShowJustificationModal(false)}
      ...
      {showMarkReviewedModal && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-[#111827] text-[18px]">Mark Event as Reviewed</h3>
              <button
                onClick={() => setShowMarkReviewedModal(false)}
                className="w-[32px] h-[32px] rounded-[8px] hover:bg-[#f9fafb] flex items-center justify-center"
              >
            ...
            <textarea
              placeholder="Admin review summary and decision..."
              className="w-full h-[100px] px-[12px] py-[10px] border border-[#e5e7eb] rounded-[8px] font-['Arimo',sans-serif] text-[13px] mb-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#6366f1]"
            />
      ...
      {showAdminNotesModal && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-8"
          onClick={() => setShowAdminNotesModal(false)}
        >
          <motion.div
            initial={{ scale: 0.95 }}
            animate={{ scale: 1 }}
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-[#111827] text-[18px]">Add Admin Notes</h3>
              <button
                onClick={() => setShowAdminNotesModal(false)}
                className="w-[32px] h-[32px] rounded-[8px] hover:bg-[#f9fafb] flex items-center justify-center"
              >
            ...
            <textarea
              placeholder="Add confidential admin notes here..."
              className="w-full h-[120px] px-[12px] py-[10px] border border-[#e5e7eb] rounded-[8px] font-['Arimo',sans-serif] text-[13px] mb-4 resize-none focus:outline-none focus:ring-2 focus:ring-[#6366f1]"
            />
            <div className="flex items-center justify-end gap-3">
              <button
                onClick={() => setShowAdminNotesModal(false)}
