...
export function SkillClusteringWorkflow({
  ...
  const mockSkillsData: Record<number, Skill[]> = {
    1: [
      { id: 's1', name: 'React', category: 'technical', proficiency: 'expert', yearsOfExperience: 5, source: 'resume' },
      { id: 's2', name: 'TypeScript', category: 'technical', proficiency: 'advanced', yearsOfExperience: 4, source: 'assessment' },
      { id: 's3', name: 'Node.js', category: 'technical', proficiency: 'advanced', yearsOfExperience: 4, source: 'resume' },
      { id: 's4', name: 'Leadership', category: 'interpersonal', proficiency: 'advanced', yearsOfExperience: 3, source: 'interview' },
      { id: 's5', name: 'Communication', category: 'interpersonal', proficiency: 'expert', yearsOfExperience: 5, source: 'interview' },
      { id: 's6', name: 'GraphQL', category: 'technical', proficiency: 'intermediate', yearsOfExperience: 2, source: 'resume' },
    ],
    2: [
      { id: 's7', name: 'React', category: 'technical', proficiency: 'advanced', yearsOfExperience: 3, source: 'resume' },
      { id: 's8', name: 'JavaScript', category: 'technical', proficiency: 'expert', yearsOfExperience: 6, source: 'assessment' },
      { id: 's9', name: 'CSS', category: 'technical', proficiency: 'advanced', yearsOfExperience: 5, source: 'resume' },
      { id: 's10', name: 'Team Collaboration', category: 'interpersonal', proficiency: 'advanced', yearsOfExperience: 4, source: 'interview' },
      { id: 's11', name: 'Problem Solving', category: 'interpersonal', proficiency: 'expert', yearsOfExperience: 6, source: 'interview' },
    ],
    3: [
      { id: 's12', name: 'React', category: 'technical', proficiency: 'intermediate', yearsOfExperience: 2, source: 'resume' },
      { id: 's13', name: 'TypeScript', category: 'technical', proficiency: 'intermediate', yearsOfExperience: 2, source: 'assessment' },
      { id: 's14', name: 'Python', category: 'technical', proficiency: 'advanced', yearsOfExperience: 4, source: 'resume' },
      { id: 's15', name: 'Communication', category: 'interpersonal', proficiency: 'advanced', yearsOfExperience: 3, source: 'interview' },
      { id: 's16', name: 'Adaptability', category: 'interpersonal', proficiency: 'advanced', yearsOfExperience: 3, source: 'interview' },
    ],
  };
  ...
  const handleDetectSkills = () => {
    ...
    setTimeout(() => {
      ...
      candidates.forEach(candidate => {
        const candidateSkills = mockSkillsData[candidate.id] || [];
        skillsMap.set(candidate.id, candidateSkills);
