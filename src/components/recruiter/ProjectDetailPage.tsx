import { ArrowLeft, Users, Calendar, MapPin, DollarSign, Clock, CheckCircle2, AlertCircle } from 'lucide-react';
        ...
        <div className="col-span-2 space-y-6">
          ...
          <Card className="p-8 bg-white rounded-2xl shadow-sm">
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                We are looking for talented individuals to join our team and work on exciting projects that will shape the future of our organization. This role offers great opportunities for growth and development.
              </p>
              <p>
